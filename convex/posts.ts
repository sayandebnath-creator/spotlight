...
export const toogleLike = mutation({
    // which post we are going to like or unlike
    args:{
        postId: v.id("posts"),
    },
    handler: async (ctx, args) => {
...
export const deletePost = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        // delete associated likes, comments, bookmarks, notifications
...
export const getPostsByUser = query({
    ...
    handler: async (ctx, args) => {
        // if user id is provided, get that user's posts
        // else get posts of the authenticated user
